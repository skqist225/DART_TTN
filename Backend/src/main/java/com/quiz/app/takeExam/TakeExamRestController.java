...
import com.quiz.app.takeExam.dto.PostCreateSubjectDTO;
import com.quiz.app.takeExam.dto.SubjectDTO;
import com.quiz.app.takeExam.dto.SubjectsDTO;
...
@RestController
@RequestMapping("/api/takeExam")
public class TakeExamRestController {
    @Autowired
    private TakeExamService subjectService;
